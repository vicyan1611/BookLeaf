...
const fetchBooks = async (userID: string): Promise<Book[]> => {
  try {
    const response = await fetch(
      "http://localhost:3000/api/books/getUserBooks",
      {
        method: "POST",
        headers: {
...
const PersonalInfoSection = () => (
  <div className="p-6">
    ...
    <div className="bg-white p-4 shadow rounded-lg">
      <p>
        Hello, I’m an avid reader and especially love mangoes, fanfictions,
        yahdeeyahda, blah blah blah...
      </p>
    </div>
            ...
            <div className="bg-white p-4 shadow rounded-lg">
              <form onSubmit={handlePasswordChange}>
                ...
                <input
                  ...
                  name="oldPass"
                  type="password"
                  className="w-1/3 px-2 py-2 rounded-lg border-2 focus:outline-none"
                />
                <br />
    ...
    <div className="flex h-screen mx-auto my-0">
      ...
      <div className="flex-grow bg-gray-50">
        <header className="bg-green-100 p-4 flex justify-between items-center">
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-sm text-gray-600">{props.viewingUser.email}</p>
            </div>
          </div>
          {!props.isActiveUser ? (
        ...
        <main>
          ...
          {active === "account" && (
            <AccountManagementSection isActiveUser={props.isActiveUser} />
          )}
        </main>
      </div>
    </div>
